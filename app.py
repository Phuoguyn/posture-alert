...
def monitor_section():
    ...
    with colL:
        ...
        # --- TEMPORARILY DISABLE WEBCAM FOR SMOKE TEST ---
        ...
        with st.expander("Webcam (temporarily disabled for smoke test)", expanded=True):
            ...
            st.caption("If the page loads and you see this, the app is healthy. The hang was inside WebRTC.")
    ...
    st.info("Coaching: If you see red banner, adjust your back / head / neck. "
